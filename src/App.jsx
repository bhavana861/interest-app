...
<div style={{width:'600px'}} className='bg-light rounded p-5'>
  ...
  <form className='mt-5'>
    ...
    <Button type='submit' onClick={handleCalculate} disabled={invalidPrinciple||invalidRate||invalidYear} className='bg-dark' style={{width:'50%',height:'70px'}} variant="contained">Calculate</Button>
    <Button onClick={handleReset} className='border border-dark' style={{width:'50%',height:'70px'}}  variant="outlined">Reset</Button>
    </Stack>
    </form>
    </div>
    </div>
